      ...
      <div className="h-screen bg-gradient-to-r from-primary/5 via-transparent to-primary/5">
        ...
        <div className="max-w-4xl mx-auto p-8 pt-32 pb-20">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Real-time status of all {siteConfig.name} services and dependencies.</p>
          </div>
          ...
          <Card className="p-4 mt-6 bg-muted/50">
            ...
            <p className="text-sm text-muted-foreground">
              This page monitors the status of core services and dependencies used by {siteConfig.name}.
