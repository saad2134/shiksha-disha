...
const DEFAULT_GLOW_COLOR = '145, 60, 255';
const MOBILE_BREAKPOINT = 768;

const cardData = [
  {
    title: 'Smart Pathway Engine',
    description: 'AI analyzes learner profiles to generate personalized NSQF-aligned career routes tailored to your goals',
    label: 'AI-Powered',
    icon: Brain
  },
  {
    title: 'Personalized Matching',
    description: 'Smart course matching based on your learning style, preferences, and career aspirations',
    label: 'Custom',
    icon: Target
  },
  {
    title: 'NSQF Integration',
    description: 'Access 139+ government courses aligned with National Skills Qualifications Framework',
    label: 'Certified',
    icon: GraduationCap
  },
  {
    title: 'Career Journey Map',
    description: 'Visual roadmap tracking your progress from beginner to industry-ready professional',
    label: 'Track',
    icon: MapPin
  },
  {
    title: 'Impact Analytics',
    description: 'Track your skills gained, courses completed, and employment probability projections',
    label: 'Analytics',
    icon: BarChart3
  },
  {
    title: 'Learning Schedule',
    description: 'Book and manage your learning sessions at your convenience with smart reminders',
    label: 'Schedule',
    icon: Calendar
  },
  {
    title: 'Achievements & Gamification',
    description: 'Earn badges, unlock levels, and compete on leaderboards as you progress',
    label: 'Gamified',
    icon: Award
  },
  {
    title: 'AI Learning Companion',
    description: 'Real-time guidance, industry alerts, skill forecasts, and content recommendations',
    label: 'Assistant',
    icon: Sparkles
  }
];
